...
import { motion, useScroll, useTransform } from "framer-motion";import { useRef, useState, useEffect } from "react";
import "./Mobile.css";
          ...
          <motion.div className="overlay" ref={ref} style={{ y }}>
            ...
            <div className="overlay-row top-row">
              ...
              <div className="socials">
                ...
                <button className="icon"><FaInstagram size={20}  />
</button>
                <button className="icon" size={20}><FaLinkedin />
</button>
              </div>
            </div>
            <div className="quote">
            ...
            <div className="overlay-row bottom-row">
              <div className="left">
                ...
                <div className="cta-row">
                  <button className="btn-primary">Get Started <span>
              ...
              <div className="right">
                ...
                <div className="globe">
                    <TbWorld size={25} strokeWidth={1.5}/></div>
                <div className="world">
                  Available Worldwide
                </div>
                </div>
                ...
                <a className="contact" href="#contact">
                  Contact me <span><MdArrowOutward className="arrow-icon" size={15} /></span>
                </a>
              </div>
            </div>
          </motion.div>
